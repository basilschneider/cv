...
\begin{entrylist}
  ...
  \entry
  {}
  {I am co-author of 213 ATLAS publications; for a full list, see \\
  ...
  {A general approach to search for supersymmetry at the LHC by combining signal enhanced kinematic regions using the ATLAS detector (PhD thesis)}
...
\begin{entrylist}
  ...
  \entry
  {\parbox[t]{\parboxWidthOne}{Jul}\parbox[t]{\parboxWidthTwo}{\hfill '14} - Jul '14}
  {\textbf{Dr. Jamie Boyd}}
