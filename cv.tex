...
\begin{entrylist}
  ...
  \entry
  {\parbox{\parboxWidthOne}{May}\parbox{\parboxWidthTwo}{\hfill '13}}
...
detector''}
  ...
  \entry
  {\parbox{\parboxWidthOne}{Jun}\parbox{\parboxWidthTwo}{\hfill '11}}
...
{}
  ...
  \entry
  {\parbox{\parboxWidthOne}{May}\parbox{\parboxWidthTwo}{\hfill '14}}
  ...
  \entry
  {\parbox{\parboxWidthOne}{Feb}\parbox{\parboxWidthTwo}{\hfill '14}}
  ...
  \entry
  {\parbox{\parboxWidthOne}{Jun}\parbox{\parboxWidthTwo}{\hfill '13}}
  ...
  \entry
  {\parbox{\parboxWidthOne}{Mar}\parbox{\parboxWidthTwo}{\hfill '13}}
  {Search for direct production of charginos and neutralinos in events with three leptons and missing transverse momentum in 21
    fb\textsuperscript{-1} of pp collisions at $\sqrt{\mathsf{s}}$ = 8 TeV with the ATLAS detector}
...
{\vspace*{\spacingPubs}}
  ...
  \entry
  {\parbox{\parboxWidthOne}{Nov}\parbox{\parboxWidthTwo}{\hfill '12}}
  ...
  \entry
  {\parbox{\parboxWidthOne}{Aug}\parbox{\parboxWidthTwo}{\hfill '12}}
  {Search for direct production of charginos and neutralinos in events with three leptons and missing transverse momentum in $\sqrt{\mathsf{s}}$ =
  ...
  \entry
  {\parbox{\parboxWidthOne}{Nov}\parbox{\parboxWidthTwo}{\hfill '11}}
  {The ATLAS IBL BOC Demonstrator}
  {\href{https://cds.cern.ch/record/1401224}{ATL-INDET-PROC-2011-038}}
  {\vspace*{\spacingPubs}}

  \entry
  {\parbox{\parboxWidthOne}{Oct}\parbox{\parboxWidthTwo}{\hfill '11}}
...
\entry
{\parbox{\parboxWidthOne}{Dec}\parbox{\parboxWidthTwo}{\hfill '13}}
...
\entry
{\parbox{\parboxWidthOne}{Oct}\parbox{\parboxWidthTwo}{\hfill '13}}
...
\entry
{\parbox{\parboxWidthOne}{Jul}\parbox{\parboxWidthTwo}{\hfill '13}}
...
\entry
{\parbox{\parboxWidthOne}{Dec}\parbox{\parboxWidthTwo}{\hfill '12}}
...
\entry
{\parbox{\parboxWidthOne}{Sep}\parbox{\parboxWidthTwo}{\hfill '12}}
